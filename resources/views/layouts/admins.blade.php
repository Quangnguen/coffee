            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <ul class="navbar-nav side-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('show.orders') }}" style="margin-left: 20px;">Orders</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('show.products') }}" style="margin-left: 20px;">Products</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('show.bookings') }}" style="margin-left: 20px;">Bookings</a>
                        </li>
                    </ul>
                    @endauth
