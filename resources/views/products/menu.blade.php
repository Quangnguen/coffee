            ...
            <div class="book p-4">
                ...
                <form action="#" class="appointment-form">
                    ...
                    <div class="d-md-flex">
                        ...
                        @else
                        <div class="form-group ml-md-4">
                            <input name="submit" type="submit" value="Login to booking" class="btn btn-white py-3 px-4" disabled>
                        </div>
                        @endif
                    </div>
                </form>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="pricing-entry d-flex ftco-animate">
                    <div class="img" style="background-image: url({{ asset('assets/image/'.$dessert->image.'') }});"></div>
                    <div class="desc pl-3">
            ...
            <div class="col-md-6">
                ...
                <div class="pricing-entry d-flex ftco-animate">
                    <div class="img" style="background-image: url({{ asset('assets/image/'.$drink->image.'') }});"></div>
                    <div class="desc pl-3">
                        <div class="d-flex text align-items-center">
                        ...
                        <div class="tab-content ftco-animate" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="#" class="menu-img img mb-4" style="background-image: url({{ asset('assets/images/'.$drink->image.'') }});"></a>
                                            <div class="text">
                            ...
                            <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <div class="menu-wrap">
                                            <a href="#" class="menu-img img mb-4" style="background-image: url({{ asset('assets/images/'.$dessert->image.'') }});"></a>
                                            <div class="text">
