        ...
        <div class="row">
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <form method="POST" action="{{ route('add.cart', $product->id) }}">
                    ...
                    @if($checkingInCart == 0)
                    <button style="background-color: #000;" type="submit" name="submit" href="cart.html" class="btn  btn-primary py-3 px-5">Add to Cart</button>
                    @else
                    <button style="background-color: #000;" disabled href="cart.html" class="btn btn-primary py-3 px-5">Added to Cart</button>
                    @endif
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="menu-entry">
                    <a href="{{ route('product.single', $product->id) }}" class="img" style="background-image: url({{ asset('assets/images/'.$relatedProduct->image.'') }});"></a>
